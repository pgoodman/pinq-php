...
abstract class PinqDbResource extends Resource
	...
	public function GET($query, array $args = array()) {
		return $this->select($this->substituteArgs($query, $args));
	}
	...
	public function PUT($query, array $args = array()) {
		return (bool)$this->update($this->substituteArgs($query, $args));
	}
	...
	public function POST($query, array $args = array()) {
		if($this->update($this->substituteArgs($query, $args)))
	 ...
	 */
	public function DELETE($query, array $args = array()) {
		return (bool)$this->update($this->substituteArgs($query, $args));
	}
	 ...
	 */
	protected function substituteArgs($stmt = '', array $args = array()) {
